...
import { getErrorMessage, logError, isApiError, isNetworkError } from '@/shared/utils/error.utils';
...
export function ErrorTester() {
  ...
  if (shouldThrow) {
    throw new Error('Test error: This error is intentionally thrown to test ErrorBoundary');
  }
  ...
  const testLongDurationToast = () => {
    showToast('This toast will stay for 10 seconds', 'info', 'Long Duration', 10000);
  };
