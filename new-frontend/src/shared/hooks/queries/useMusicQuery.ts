...
export function useGenerateMary(onSuccess?: (xml: string) => void) {
  return useMutation({
    mutationFn: async (_request: GenerateMaryRequest): Promise<MusicXmlResponse> => {
...
export function useGenerateRhythm(onSuccess?: (xml: string) => void) {
  return useMutation({
    mutationFn: async (_request: GenerateRhythmRequest): Promise<MusicXmlResponse> => {
      // TODO: Replace with actual API call
 ...
 */
export function useGenerateNoteGame(onSuccess?: (noteInfo: NoteGameResponse) => void) {
  return useMutation({
    mutationFn: async (_request: NoteGameRequest): Promise<NoteGameResponse> => {
      // TODO: Replace with actual API call
...
export function useRenderSheetMusic() {
  const renderXml = async (_xml: string, containerId: string = 'sheet-music-div') => {
