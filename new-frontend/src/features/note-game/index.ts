...
export type { GameSettingsProps, GameBoardProps, GameResultsProps } from './components';

// Types
export type { GameMode, GameState, NoteAnswer, GameStats, GameSettings as GameSettingsType } from './types';
