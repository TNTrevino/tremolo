          ...
          <div className="space-y-6">
            <div className="flex gap-4 items-start">
              ...
              <div className="flex-1">
                <h3 className="text-2xl font-bold mb-2">Real Reading, Not Memorization</h3>
                <p className="text-muted-foreground text-lg">
                  The biggest challenge in music education is students memorizing pieces instead of
                  learning to sight-read. Our dynamic exercises prevent memorization by generating
                  unique patterns every time, forcing students to engage with actual note reading.
                </p>
              </div>
            </div>
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-6">
            <div className="flex gap-4 items-start">
              ...
              <div className="flex-1">
                <h3 className="text-2xl font-bold mb-2">Advanced Skill Development</h3>
                <p className="text-muted-foreground text-lg">
                  Work on complex chord structures, challenging scale degree jumps, and intricate
                  intervallic patterns. Build the sight-reading skills that separate good musicians
                  from great ones.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4 items-start">
              ...
              <div className="flex-1">
                <h3 className="text-2xl font-bold mb-2">Practice What You Need</h3>
                <p className="text-muted-foreground text-lg">
                  Preparing for an audition? Working on a challenging piece? Customize your practice
                  to target exactly what you need. Track your progress with detailed analytics and
          ...
          <Card className="border-primary/50 shadow-lg bg-gradient-to-br from-primary/5 to-accent/5">
            ...
            <CardContent className="text-lg text-muted-foreground">
              ...
              <p className="mt-4">
                ...
                to everyone. Real skills. Real progress. Real results.
              </p>
            </CardContent>
          </Card>
        </section>
