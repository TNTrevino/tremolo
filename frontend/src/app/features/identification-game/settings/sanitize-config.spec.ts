...
/**
 * Ported from
 * frontend-react/src/features/identification-game/settings/sanitizeConfig.test.ts.
 *
 * The five cases are unchanged; only the imports moved and the vitest
 * imports are dropped (globals are on -- see `tsconfig.spec.json`).
 */
