 ...
 * index: C0 = 0, D0 = 1, ... B0 = 6, C1 = 7, and so on. One index step
 * is one staff position (line or space).
 */

import type { RangeClef } from "@/services/api/types";
import { NATURAL_NOTES as LETTERS } from "@/features/identification-game";
...
/**
 * Vertical offset of a note in staff-position steps relative to the
 * bottom staff line (positive = above the bottom line).
 */
